document.addEventListener("DOMContentLoaded", () => {
    ...
    sliders.forEach((sliderContainer) => {
        const slides = sliderContainer.querySelectorAll(".fish-slider img");
    ...
    document.querySelectorAll(".fish-fact").forEach((fact) => {
    ...
    document.querySelectorAll(".fish-text p:first-of-type").forEach((p) => {
    ...
    const cards = Array.from(document.querySelectorAll(".fish-grid .fish-card"));
    ...
    if (cards.length && numbersEl && prevPageBtn && nextPageBtn) {
        ...
        function goToPage(page, scroll) {
            ...
            if (infoEl) {
                infoEl.textContent = `Mostrando ${start}–${end} de ${cards.length} peces`;
            }

            if (scroll) {
                const section = document.querySelector(".fish-catalog");
                if (section) {
                    window.scrollTo({
